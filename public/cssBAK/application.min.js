...
.loader:after{
    ...
    border-radius: 50%;
    opacity: 0;
    -webkit-animation: popin 1.5s linear infinite 0.5s;
...
.card:hover {
    -webkit-box-shadow: 0 5px 30px rgba(0, 0, 0, 0.02);
...
.sidebar-menu {
    ...
    overflow: hidden;
    background: #303641;
    -webkit-box-shadow: 2px 0 32px rgba(0, 0, 0, 0.05);
...
.horizontal-menu .submenu {
    ...
    border-radius: 3px;
    -webkit-box-shadow: 0 2px 15px rgba(0, 0, 0, 0.03);
...
.nav-btn span {
    ...
    -webkit-transition: all 0.3s ease 0s;
    transition: all 0.3s ease 0s;
    -webkit-box-shadow: 0 0 0 4px rgba(99, 96, 96, 0.03);
...
.user-profile {
    ...
    -ms-flex-wrap: wrap;
        flex-wrap: wrap;
    background: -webkit-gradient(linear, left top, right top, from(#8914fe), to(#8063f5));
...
.user-profile .dropdown-menu.show {
    ...
    visibility: visible;
    opacity: 1;
    -webkit-box-shadow: 0 0 45px 0 rgba(131, 23, 254, 0.06);
...
.input-form input {
    ...
    padding-left: 50px;
    border: none;
    -webkit-box-shadow: 0 0 41px rgba(67, 54, 251, 0.05);
...
.gradiant-bg .card-header a {
    background-image: -webkit-gradient(linear, left top, right bottom, from(#8914fe), to(#8160f6));
...
.prc-list>a:hover {
    -webkit-box-shadow: 0 3px 25px rgba(44, 113, 218, 0.38);
...
.dark-pricing .prc-list>a:hover {
    -webkit-box-shadow: 0 3px 25px rgba(27, 27, 27, 0.38);
...
.offset-area {
    ...
    background: #f9f9f9;
    z-index: 998;
    -webkit-box-shadow: -5px 0 20px rgba(0, 0, 0, 0.05);
